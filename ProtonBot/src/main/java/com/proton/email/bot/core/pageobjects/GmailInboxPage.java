...
public class GmailInboxPage extends BasePage {
	...
	List<WebElement> protonMessages = new ArrayList<WebElement>();
	...
	public String returnBiggerToOriginAndVerify() {
		 ...
		 */
		try {
			this.protonMessages = _driver.findElements(By.cssSelector("div.adn.ads"));
			
			for(WebElement elem : protonMessages) {
				WebElement timeIndicator = waitUntilElementPresenceByCSS("div.gK > span.g3");
				String fingerprint = timeIndicator.getText();
				System.out.println(fingerprint);
				WebElement code = elem.findElement(By.cssSelector("code"));
